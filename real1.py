...
rm_index = distinct_commands.index('ls')
ls_index = distinct_commands.index('rm')
print comat_log[0][rm_index][ls_index]
print comat_log[1][rm_index][ls_index]
print comat_log[2][rm_index][ls_index]
print comat_log[3][rm_index][ls_index]
print comat_log[4][rm_index][ls_index]
for i in range(50):
